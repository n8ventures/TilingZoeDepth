...
def main():
    ...
    else: print('ZoeDepth Repo exists!')
...
def Tiled_ZoeDepth_process(file_path):
    ...
    if torch.cuda.is_available() == True:
        ...
        update_pbar('Metal is available! Starting process...', 10, infLoad=True)
    else:
        update_pbar('Cuda not available! Using CPU instead. Starting process... ', 1, infLoad=True)
    ...
    for filenum, file in enumerate(file_path, start=1):
        ...
        for i in range(len(filters)):
            ...
            if cmore86_var.get():
                ...
                tiled_depth_map.save(f'temp/tiled_depth_{i}.tif', format='TIFF')
            else:
                ...
                tiled_depth_map.save(f'temp/tiled_depth_{i}.png')
